 ...
 * 'controllerMap' => [
 *     'assignment' => [
 *         'class' => 'cloud\admin\controllers\AssignmentController',
...
class Module extends \yii\base\Module
{
     ...
     * Its used when `layout` set to 'left-menu', 'right-menu' or 'top-menu'.
     */
    public $mainLayout = '@cloud/admin/views/layouts/main.php';
    ...
    public function init()
    {
        ...
        if (class_exists('yii\jui\JuiAsset')) {
            Yii::$container->set('cloud\admin\AutocompleteAsset', 'yii\jui\JuiAsset');
        }
    }
