...
namespace cloud\admin\components;
 ...
 * 
 * ~~~
 * Yii::$container->set('cloud\admin\components\Configs',[
 *     'db' => 'customDb',
 *     'menuTable' => 'admin_menu',
 * ]);
 * ~~~
...
class Configs extends \yii\base\Object
{
    ...
    public static function instance()
    {
        if (self::$_instance === null) {
            $type = ArrayHelper::getValue(Yii::$app->params, 'cloud.admin.configs', []);
